...
def scrape_meget_command(workers, pages):
    print(f"🚀 Starting Meget scraping with {workers} threads, {pages} pages from {MEGET_BASE_URL}...")
...
def scrape_bon_ua_command(workers, pages):
    print(f"🚀 Starting Bon.ua scraping with {workers} threads, {pages} pages from {BON_UA_BASE_URL}...")
